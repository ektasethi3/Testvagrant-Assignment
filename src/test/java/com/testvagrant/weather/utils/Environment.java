	...
	public static Map<String, String> getEnv(){
		...
		try {
			if(env.equalsIgnoreCase("qa")) {
				...
				environment.put("url", prop.getProperty("url"));
			}
			else if (env.equalsIgnoreCase("dev")) {
				FileInputStream fisdev = new FileInputStream(System.getProperty("user.dir")+"/src/test/resources/Inputs/qa.properties");
				prop.load(fisdev);
